## About the project:
This C++ program is an **interactive “Guess The Random Number” game** designed to provide a fun and challenging experience for beginners learning programming concepts.  
The game uses **random number generation**, user input, conditional statements, loops, and functions to create a fully functional and menu-driven program.  
i also tried to make the code visually clean as possible
...
##  my Experience:
This was one of my first C++ projects as a beginner. Writing this game helped me learn and practice as it was both interesting and fun experience for me it helped me learn:  
...
- making the code visually appealing.
